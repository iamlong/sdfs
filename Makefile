...
OBJ      = router/dest.o router/droute.o router/rentity.o router/rtable.o sha1/sha1.o util/utils.o fs/sinode.o fs/siblock.o fs/processlist.o fs/blocklist.o \
			util/serializer.o util/serialize.o util/network.o storage/trunk.o storage/storcmdq.o storage/storlistener.o storage/storcmd.o
...
storage/storcmdq.o: storage/storcmdq.cpp storage/storcmdq.h
	$(CPP) -c storage/storcmdq.cpp -o storage/storcmdq.o $(CXXFLAGS)

storage/storlistener.o: storage/storlistener.cpp storage/storlistener.h
	$(CPP) -c storage/storlistener.cpp -o storage/storlistener.o $(CXXFLAGS)

storage/storcmd.o: storage/storcmd.cpp storage/storcmd.h
	$(CPP) -c storage/storcmd.cpp -o storage/storcmd.o $(CXXFLAGS)
